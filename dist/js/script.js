...
window.addEventListener('DOMContentLoaded', () => {
  ...
  function setClock(selector, endtime) {
    const timer = document.querySelector(selector),
          ...
          timeInterval = setInterval(updateClock, 1000); // to run function every second
  ...
  window.addEventListener('scroll', showModalByScroll); // 48 Cards class
  ...
  ценой и высоким качеством!`, 9, '.menu .container', 'menu__item').render();
  ...
  в ресторан!`, 21, '.menu .container', 'menu__item').render();
  ...
  количество белков за счет тофу и импортных вегетарианских стейков.`, 16, '.menu .container', 'menu__item').render(); // Forms
